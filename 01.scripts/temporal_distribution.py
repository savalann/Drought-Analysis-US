        ...
        for station_index, station_number in enumerate(valid_statin_numbers):
            ...
            for rp_index, return_period in enumerate([10, 20, 50, 100]):
                ...
                for jj, j in enumerate([0, 20, 40]):
                    ...
                    stat_all[station_index, zz+jj] = stats.genpareto.ppf(1-1/return_period, *part_distribution_params)
...
writer = pd.ExcelWriter(state_name+'_temporal.xlsx', engine='xlsxwriter')
...
for jj, state_name in enumerate([all_10, all_20, all_50, all_100]):
    ...
    # set height of bar
    IT = state_name.iloc[3:6, 3]
    ECE = state_name.iloc[3:6, 2]
    CSE = state_name.iloc[3:6, 1]
    ...
    plt.bar(br1, IT, color='r', width=barWidth,
            edgecolor='grey', label='1950-1980')
    plt.bar(br2, ECE, color='g', width=barWidth,
            edgecolor='grey', label='1970-2000')
    plt.bar(br3, CSE, color='b', width=barWidth,
            edgecolor='grey', label='1990-2020')
    ...
    plt.legend()
    plt.savefig(str(zz[jj])+'_years_return_period')
